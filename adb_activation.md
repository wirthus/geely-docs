...
> **Предупреждение**
> Описанные ниже действия изменяют системные настройки головного устройства и открывают доступ к ADB.
> Неправильные действия после активации могут привести к нестабильной работе системы, поэтому продолжайте только если понимаете последствия.
